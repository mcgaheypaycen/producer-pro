/** Shared run sheet typography defaults and normalization (main + renderer). */

const RUN_SHEET_FIELD_KEYS = ['aesthetic', 'length', 'lighting', 'stage'];

const RUN_SHEET_FIELD_LABELS = {
  aesthetic: 'Aesthetic',
  length: 'Length',
  lighting: 'Lighting',
  stage: 'Stage',
...
function normalizeRunSheetOptions(saved) {
  return {
